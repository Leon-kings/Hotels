        ...
        <div className="p-4 mt-2">
          ...
          <div className="flex justify-between">
            <button 
              ...
              className="bg-primary hover:bg-primary-dark text-white text-sm py-2 px-4 rounded"
            >
              View Detail
            </button>
            <button 
              onClick={() => onBookNow(room)}
              className="bg-gray-800 hover:bg-gray-900 text-white text-sm py-2 px-4 rounded"
            >
              Book Now
            </button>
          </div>
...
export const RoomsServices = () => {
  ...
  const handleViewDetail = (room) => {
    ...
    // Here you can implement what happens when viewing details
    // For example: navigate to a detail page, show a modal, etc.
    console.log("Viewing details for:", room.name);
  ...
  const handleBookNow = (room) => {
    ...
    alert(`Initiating booking for ${room.name}\nPrice: $${room.price}/night`);
  };
