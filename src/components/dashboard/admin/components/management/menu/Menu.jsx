...
const MenuItemCard = ({ item, delay, onViewDetail, onAddToCart, onToggleFavorite, isFavorite }) => {
...
// Success Modal with Receipt - FIXED PDF GENERATION
  ...
  const generateSimplePDF = () => {
    try {
      ...
      import('jspdf').then((jsPDFModule) => {
        ...
        yPos += 20;
        doc.text(`Customer: ${paymentData?.customerName || 'Guest'}`, 20, yPos);
        doc.text(`Email: ${paymentData?.customerEmail || 'N/A'}`, 20, yPos + 5);
    ...
    const receiptContent = `
      <html>
        ...
        <body>
          ...
          <div class="details">
            <p><strong>Name:</strong> ${paymentData?.customerName || 'Guest'}</p>
            <p><strong>Email:</strong> ${paymentData?.customerEmail || 'N/A'}</p>
      ...
      >
        ...
        <div className="mb-6 border rounded-lg p-4 bg-gray-50 text-left">
          ...
          <div className="text-sm mb-3">
            <p><span className="font-semibold">Name:</span> {paymentData?.customerName || 'Guest'}</p>
            <p><span className="font-semibold">Email:</span> {paymentData?.customerEmail || 'N/A'}</p>
          </div>
