  ...
  const handleStatusChange = async (bookingId) => {
    try {
      ...
      if (originalBooking?.status === "confirmed") {
        setConfirmedBookings(prev => [...prev, originalBooking].sort((a, b) => 
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {currentBookings.map((booking) => (
                <tr key={booking._id} className="bg-green-50 hover:bg-green-100">
        ...
        {confirmedBookings.length === 0 && (
          <div className="p-4 text-center text-gray-500">No confirmed bookings found</div>
        )}
        ...
        {totalPages > 1 && (
          <div className="px-6 py-4 bg-gray-50 flex justify-between items-center">
            <div>
              ...
              {Math.min(currentPage * bookingsPerPage, confirmedBookings.length)} of{" "}
