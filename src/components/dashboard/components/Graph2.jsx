...
export const MessagesAnalytics = () => {
  ...
  const fetchCounts = async () => {
    ...
    try {
      const endpoints = [
        ...
        { key: 'messages', url: 'https://hotel-nodejs-oa32.onrender.com/63729/892308' },
        { key: 'revenue', url: 'https://hotel-nodejs-oa32.onrender.com/83920/92303' },
        { key: 'orders', url: 'https://hotel-nodejs-oa32.onrender.com/84383/92823' }
      ];
  ...
  const metricCards = [
    ...
    },
    {
      key: 'messages',
      title: 'Messages',
      icon: <Email className="text-xl" />,
      color: 'bg-green-100 text-green-600'
    },
    {
      key: 'revenue',
      title: 'Revenue Items',
      icon: <MonetizationOn className="text-xl" />,
  ...
  return (
    <div className="p-5 font-sans">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h4 className="text-2xl font-semibold text-gray-800">Data Count Dashboard</h4>
        <button 
          onClick={fetchCounts}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {metricCards.map((metric) => {
          ...
          return (
            <div key={metric.key} className="bg-white rounded-lg shadow-md p-6 min-h-[140px]">
              {data.loading ? (
