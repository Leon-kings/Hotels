...
// export const DashboardMeManagement = () => {
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onBlur={handleBlur}
                        readOnly
                        className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl bg-gray-100 text-black cursor-not-allowed"
                        placeholder="john@example.com"
                      />
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Update your password for security</p>
                    </div>
                    <button
                      type="button"
                      onClick={() => setIsChangingPassword(!isChangingPassword)}
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                        isChangingPassword ? 'bg-blue-600' : 'bg-gray-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          isChangingPassword ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>
                      ...
                      {formData.newPassword && (
                        <div className="bg-blue-50 border border-blue-200 rounded-xl p-3">
                          ...
                          <ul className="space-y-1">
                            ...
                            <li className="flex items-center text-xs text-blue-700">
                              <svg className={`w-4 h-4 mr-2 ${/[A-Z]/.test(formData.newPassword) ? 'text-green-500' : 'text-blue-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                              </svg>
                              At least one uppercase letter
                            </li>
                            ...
                            <li className="flex items-center text-xs text-blue-700">
                              <svg className={`w-4 h-4 mr-2 ${/[0-9]/.test(formData.newPassword) ? 'text-green-500' : 'text-blue-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                              </svg>
                              At least one number
                            </li>
...
// Main UserManagement Component (User-facing version)
export const DashboardMeManagement = () => {
  ...
  useEffect(() => {
    ...
    if (email) {
      ...
      toast.error('No user email found in cookies. Please log in.');
      setLoading(false);
    }
  }, []);
    ...
    setConfirmAction({
      ...
      onConfirm: async () => {
        try {
          ...
          await axios.delete(
            `https://hotel-nodejs-oa32.onrender.com/37829/7892/${user._id}`,
            {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
              }
          ...
          setModalMessage(error.response?.data?.message || "Failed to delete account");
          setShowFailModal(true);
        } finally {
          setLoading(false);
          setShowConfirmModal(false);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">No user email found in cookies. Please log in to access your profile.</p>
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <StatsCard 
              ...
              value={user?.status || user?.role || "Active"}
              color="from-green-500 to-green-600"
            />
            <StatsCard 
              icon={Verified}
            ...
            <div className="relative h-48 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">
              <div className="absolute -bottom-16 left-8">
                <div className="w-32 h-32 rounded-full bg-white border-4 border-white shadow-xl flex items-center justify-center">
                  {user?.status === "admin" || user?.role === "admin" ? (
                    <AdminPanelSettings className="w-16 h-16 text-purple-600" />
                  ) : (
                    <Person className="w-16 h-16 text-blue-600" />
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h3 className={`text-lg font-semibold mb-4 flex items-center ${
                    ...
                    <Security className="w-5 h-5 mr-2 text-purple-500" />
                    Account Information
                  </h3>
                ...
                <div className="p-4 rounded-lg border border-red-200 bg-red-50">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg hover:shadow-lg transition-all whitespace-nowrap"
                    >
                      Delete Account
                    </motion.button>
                  </div>
