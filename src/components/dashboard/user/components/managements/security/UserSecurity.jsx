...
export const UserSecurityManagement = () => {
  ...
  useEffect(() => {
    ...
    if (email) {
      ...
      toast.warning('No user email found in cookies. Please log in.');
      setLoading(false);
    }
  }, []);
  ...
  if (!userEmail) {
    return (
      <div className="min-h-screen bg-gradient-to-r from-gray-900 via-black to-gray-900 flex items-center justify-center p-4">
        <div className="bg-gray-800 rounded-xl shadow-lg p-8 max-w-md w-full text-center border border-gray-700">
          ...
          <p className="text-gray-400 mb-6">No user email found in cookies. Please log in to access security settings.</p>
          <motion.button
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              <div className="w-20 h-20 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center shadow-lg">
                <Icon name="person" className="w-10 h-10 text-white" />
              </div>
            </div>
          ...
          >
            ...
            <motion.div 
              ...
              className="flex flex-wrap border-b border-gray-800 bg-gray-900/50 rounded-t-xl overflow-hidden"
            >
              {[
                { id: 'overview', label: 'Overview', icon: 'security' },
                { id: 'password', label: 'Password', icon: 'lock' },
                { id: 'twofactor', label: 'Two-Factor', icon: 'two_factor' },
                  ...
                  >
                    ...
                    <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-xl p-6 border border-blue-600/20">
                      ...
                      <p className="text-gray-400">
                        Manage your account security settings and preferences below.
                      </p>
                    </div>
